...
var Godot = async () => {
	while (true) {
		if (window._dotNetApp) {
			const exports = await window._dotNetApp.getAssemblyExports("web");

			window.GetInitializeFromGameProjectPtr = exports.WebGlue.GetInitializeFromGameProjectPtr;

			console.log(`exports`, exports);
			return {
				...window._dotNetApp.Module,
				app: window._dotNetApp,
				callMain: async (args) => {
					args.unshift('godot.exe');
					console.log(`callMain`, args);
					exports.WebGlue.CallMain(args);
				}
			};
		}
		await delay(10);
...
document.getElementById("canvas").createContext = () => console.log("AAA");
